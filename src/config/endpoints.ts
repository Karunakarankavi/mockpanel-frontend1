...
export const ENDPOINTS = {
  RESUME_TOPICS: process.env.REACT_APP_RESUME_TOPICS_URL || 'http://localhost:5001/api/v1/resume/topics',
  WS_SERVER: process.env.REACT_APP_WS_URL || ' ws://0.0.0.0:8001',
  SEND_MSG: process.env.REACT_APP_SEND_MSG_URL || 'http://localhost:5001/api/v1/send-msg',
  RECONNECT: process.env.REACT_APP_RECONNECT_URL || 'http://localhost:5001/api/v1/reconnect',
